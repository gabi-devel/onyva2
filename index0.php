   ...
   <div class="client-carousel client-carousel-one ">
    ...
    <div class="client-carousel client-carousel-one ">
        <div class="container">
            ...
            <div class="owl-stage-outer"><div class="owl-stage" style="transform: translate3d(-2940px, 0px, 0px); transition: 0.7s; width: 4900px;"><div class="owl-item cloned" style="width: 190px; margin-right: 55px;"><div class="client-carousel__one__item">
                    ...
                    <img src="assets/images/resources/brand-2-1.png" alt="laboix">
                </div></div><div class="owl-item cloned active" style="width: 190px; margin-right: 55px;"><div class="client-carousel__one__item">
                    <img src="assets/images/resources/brand-2-1.png" alt="laboix">
                </div></div><div class="owl-item cloned active" style="width: 190px; margin-right: 55px;"><div class="client-carousel__one__item">
                    <img src="assets/images/resources/brand-2-1.png" alt="laboix">
                </div></div><div class="owl-item cloned" style="width: 190px; margin-right: 55px;"><div class="client-carousel__one__item">
                ...
                <div class="owl-nav">
                    <button type="button" role="presentation" class="owl-prev" aria-label="carousel button">
                        <span class="fa fa"><i class="bi bi-chevron-left"></i></span>
                    </button>
                    <button type="button" role="presentation" class="owl-next" aria-label="carousel button">
                        <span class="fa fa"><i class="bi bi-chevron-right"></i></span>

<svg xmlns="http://www.w3.org/2000/svg" width="<?php echo $size_our_products;?>" height="<?php echo $size_our_products;?>" 
fill="<?php echo $color_icon_our_products;?>" class="bi bi-hearts" viewBox="0 0 16 16">

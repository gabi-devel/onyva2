    ...
    <div class="client-carousel client-carousel-one ">
        ...
        &quot;responsive&quot;:{
            ...
            <div class="owl-stage-outer">
                <div class="owl-stage" style="transform: translate3d(-2205px, 0px, 0px); transition: 0.7s; width: 4900px;">
                    <div class="owl-item cloned" style="width: 190px; margin-right: 55px;">
                        <div class="client-carousel__one__item"> <img src="assets/images/logo-onyva.png" alt="onyva">
                        </div>
                    </div>

        ...
        <div class="topbar-one">
            <div class="container-fluid">
                <div class="topbar-one__inner">
                    ...
                    <div class="topbar-uno main-header__right">
                        <div class="topbar-uno__div">
                ...
                <div class="row">
                    <div class="col-12">
                        <div class="sec-title text-center wow fadeInUp" data-wow-duration='1500ms'>
                            <h6 class="sec-title__tagline"><img src="assets/images/shapes/sec-title-s-1.png" alt="our Service" class="sec-title__img">Nuestros servicios</h6>
                            <h3 class="sec-title__title">Ofrecemos los mejores <br> servicios para vos</h3>
                        </div>
                    </div>
                </div>
                    ...
                    <div class="col-md-6 col-lg-4">
                        <div class="service-card wow fadeInUp" data-wow-duration='1500ms' data-wow-delay='800ms'>
                            <div class="service-card__inner">
                                ...
                                <div class="service-card__thumb">
                                    <div class="service-card__thumb__item">
                                        <img src="assets/images/about/otrosprodmed12.jpg" alt="Pathology <br> testing">
                                    </div>
                                    <div class="service-card__thumb__shape">
                                        <img src="assets/images/shapes/shape-service.png" alt>
                                    </div>
                    ...
                    <div class="col-md-6 col-lg-4">
                        <div class="blog-card wow fadeInUp" data-wow-duration='1500ms' data-wow-delay='400ms'>
                            ...
                            <div class="blog-card__content">
                                ...
                                <h3 class="blog-card__title"><a href="blog-details-right.html">Lab safety is everyone’s responsivity</a></h3>
                                <div class="blog-card__content__btn">
                                    <a href="blog-details-right.html" class="blog-card__content__btn__link">Read More<i class="icon-arrow"></i></a>
                                </div>
            ...
            "responsive":{
                ...
                "1200":{
                    ...
                    <div class="client-carousel__one__item">
                        <img src="assets/images/cat.png" alt="laboix">
                    </div>
                    <div class="client-carousel__one__item">
                    ...
                    <div class="row">
                        ...
                        <div class="col-md-6 col-xl-4">
                            <div class="footer-widget footer-widget--info">
                                <a href="inedx.html" class="footer-widget__logo">
                                    <img src="assets/images/logo-onyva.png" width="130" alt="footer logo">
                                </a>
                                <!-- <h4 class="">Sede</h4><br> -->
                        ...
                        <div class="col-md-6 col-xl-3">
                            <div class="footer-widget footer-widget--about">
                                <h4 class="">Contacto</h4><br>
                                <ul class="list-unstyled footer-widget__info">
                                    <li class=""> <span class="footer-widget__info__item__text">Tel: +54 11 5235-3970</span></li>
                                    <li class=""> <i class="icon-telephone-call-1"></i><span class="footer-widget__info__item__text">Whatsapp: +54 11 51466977</span></li><!-- <a href="tel:+8801775-338747"> -->
